# Django settings for rapidsms_dev project.

import os

# The top directory for this project. Contains requirements/, manage.py,
# and README.rst, a rapidsms_dev directory with settings etc (see
...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'rapidsms_dev')
...
SECRET_KEY = '!ebjef9&646q3ip3(orqqtg9++z7al$4f4k03)qq=vu8!ku0jd'
...
ROOT_URLCONF = 'rapidsms_dev.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'rapidsms_dev.wsgi.application'
